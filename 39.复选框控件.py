...
class QCheckBoxDemo(QWidget):
    ...
    def initUI(self):
        ...
        self.checkBox1.setChecked(True)#默认为选中状态
        self.checkBox1.stateChanged.connect(lambda:self.checkboxState(self.checkBox1))#信号是状态变化statechangge
        ...
        self.checkBox3.setCheckState(Qt.PartiallyChecked)#这两部设置半选中状态的
